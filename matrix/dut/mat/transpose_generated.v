module transpose_generated #(W=7) (
    input clk,
    input enable,
    input reset,
    input do_transpose,
...
generate
    ...
    for(i=0;i<=W;i=i+1) begin
        ...
        assign z_out[i] = transpose_en ? y_out[i] : x_delay_out[i][31:0];
